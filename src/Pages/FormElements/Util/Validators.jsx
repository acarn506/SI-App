...
const VALIDATOR_TYPE_PATTERNC = "PATTERNC";
...
export const VALIDATOR_PATTERNC = () => ({ type: VALIDATOR_TYPE_PATTERNC });
...
export const validate = (value, validators) => {
  ...
  for (const validator of validators) {
    ...
    if (validator.type === VALIDATOR_TYPE_PATTERNC) {
      isValid = isValid && RegExp("[A-Za-z]{2}[0-9]{3}-[0-9]{2}").test(value);
    }
    ...
    if (validator.type === VALIDATOR_TYPE_DATE) {
      isValid =
        isValid && /^((0)[1-5])(\/)([0-2][0-9]|(3)[0-1])(\/)2020$/.test(value);
    }
